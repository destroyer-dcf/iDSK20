...
//
// Initialize a hexadecimal format string based on input value
//
...
void SetBuffViewHexa( unsigned char * src, char * Hex, char * Ascii, unsigned short Offset, int AddOffset)
{
    ...
    //
    // Go through the 512 bytes of source and fill the buffers
    //
    for ( i = 0; i < 512; i++ )
        {
        unsigned char b = * src++;
...
//
// Return AMSDOS formatted filename (8+3)
//
